...
function defaultFilterFn(key) {
    const defaultWhitelist = [
        ...
        'connects',
        'disconnects',
        // These are windowed stats with quantiles.
        'int_latency',
        'outbuf_latency',
        'rtt',
        'throttle',
        ...
        // Topic stats. These are windowed stats with quantiles
        'batchsize',
        'batchcnt',
        ...
        // Global stats/totals not yet captured by the above.
        'replyq',
        'msg_cnt',
        'msg_size',
        'msg_max',
        'msg_size_max',
        'tx_bytes',  // global stats use an underscore for these?
        'rx_bytes',
        'txmsg_bytes',
        'rxmsg_bytes'
    ];
